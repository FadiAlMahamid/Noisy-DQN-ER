...
def main():
    ...
    # noise sampling, and replay buffer sampling are deterministic.
    seed = cfg["seed"]
    np.random.seed(seed)
    ...
    # MPS is checked first because this project targets macOS development.
    ...
    agent = DQNAgent(
        ...
        sigma_init=agent_cfg.get("sigma_init", 0.5)
    )
